...
optionsEWT = Dict{Symbol,Any}(
    ...
    :batchSize => 32,
    :numEpochs => 30,
    :trainCorpus => string(pwd(), "/dat/dep/eng/2.7/en_ewt-ud-dev.conllu"), # train
    :validCorpus => string(pwd(), "/dat/dep/eng/2.7/en_ewt-ud-dev.conllu"),
    :testCorpus => string(pwd(), "/dat/dep/eng/2.7/en_ewt-ud-test.conllu"),
    :modelPath => string(pwd(), "/dat/aep/rev/eng-mlp.bson"), # rev for revision (of the manuscript)
    :wordPath => string(pwd(), "/dat/aep/rev/eng-word.txt"),
    :shapePath => string(pwd(), "/dat/aep/rev/eng-shape.txt"),
    :posPath => string(pwd(), "/dat/aep/rev/eng-partOfSpeech.txt"),
    :labelPath => string(pwd(), "/dat/aep/rev/eng-label.txt"),
    :numCores => 4,
    :verbose => false,
    :bidirectional => false,
    :gpu => false,
    :logPath => string(pwd(), "/dat/aep/rev/eng-loss.txt"),
    :scorePath => string(pwd(), "/dat/aep/rev/experiments-eng.jsonl"),
    :unknown => "[unk]",
    :padding => "[pad]",
