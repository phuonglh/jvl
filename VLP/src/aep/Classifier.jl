...
"""
    ...
    Extract selected features from an array of features obtained by the Oracle.jl utility.
"""
function extract(features::Array{String}, prefixes::Array{String})::Array{String}
    ...
    # @assert length(ws) == optionsVUD[:featuresPerContext]
    return ws
end
...
"""
    vectorizeSentence(sentence, wordIndex, shapeIndex, posIndex, options)
...
"""
function vectorizeSentence(sentence::Sentence, wordIndex::Dict{String,Int}, shapeIndex::Dict{String,Int}, posIndex::Dict{String,Int}, options)
